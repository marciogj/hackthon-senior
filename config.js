module.exports = {
  ...
  TOKEN_SECRET: process.env.TOKEN_SECRET || 'SENIOR-HCM-CONARH',

  // OAuth 2.0
  FACEBOOK_SECRET: process.env.FACEBOOK_SECRET || '1cf5327af8ea891fcf1a6084c9723e35',
  GOOGLE_SECRET: process.env.GOOGLE_SECRET || '63sAvcS55B6XoUQa9FbDOxv5',
  LINKEDIN_SECRET: process.env.LINKEDIN_SECRET || 'jt0Ang5wMtnC1Szv',
...
*/
  // OAuth 1.0
  TWITTER_KEY: process.env.TWITTER_KEY || '0nzXkohQ5x6YGKfduLwwp9XjE',
  TWITTER_SECRET: process.env.TWITTER_SECRET || 'Odmhkx2TnkNYmBE0vtvRLo7tmGMMt2VOSkdnyWuR8AAtZa4NiB'
};
